...
class RequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update request" do
    patch request_url(@request), params: { request: { address: @request.address, article: @request.article, customer_id: @request.customer_id, description: @request.description, service_tipe: @request.service_tipe } }
